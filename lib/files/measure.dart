...
class _MeasurePageState extends State<MeasurePage> {
  ...
  floatingActionButton: FloatingActionButton(backgroundColor:Colors.white,child: Icon(Icons.restart_alt_outlined,color: Colors.pinkAccent,),onPressed: () async{
    var stream = await arkitController.snapshot();
    setState((){
  ...
  void _onARTapHandler(ARKitTestResult point) {
    ...
    final material = ARKitMaterial(
        ...
        diffuse: ARKitMaterialProperty.color(Colors.pinkAccent));
